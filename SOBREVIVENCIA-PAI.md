...
- **Cofre público criptografado** — espelho fechado da casa privada em `cofre-nebula-criptografado`; chave guardada somente na pasta `preservacao/` do repo privado, que você já acessa.
